...
export default function LayoutApp ({ children }) {
  return (
    ...
    <header className="sticky z-20 bg-primary-200 dark:bg-secondary-500 top-0 h-[6rem]">
      <Header/>
    </header>
    ...
    <footer className="sticky z-10 bg-primary-200 dark:bg-secondary-500 bottom-0 h-[6rem] pt-[1rem]">
      <Navigation/>
    </footer>
    </section>
  );
