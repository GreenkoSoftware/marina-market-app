...
export default function tableProducts () {
    ...
    const { listSales, listCategories, listInventory: list, getCategories, getListInventory, addFromNewSales } = useSalesStore(
        ({ listSales, listCategories, listInventory, getCategories, getListInventory, addFromNewSales }) => (
            { listSales, listCategories, listInventory, getCategories, getListInventory, addFromNewSales }))
    useEffect(() => {
        if (selected) {
